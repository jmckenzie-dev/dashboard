---
submitted-at: "2026-06-27T16:17:29.104Z"
title: "Fix: Defunct Error-Status Session Stuck Visible After `/new`"
auto-captured: true
---
...
- Both the old (errored) and new (post-`/new`) sessions share the same
  `directory` value.
- The dashboard reads from SQLite (primary path) for the full session roster.
